    ...
    try:
        ...
        for cookie_name, cookie_value in signed_cookies.items():
            response.set_cookie(
                ...
                expires=expire_time,
                path="/",
                domain="cdn.vamory.vadaevri.com",  # Commented out - cookie will use the response domain
                secure=True,  # Required for production HTTPS
                httponly=True,  # Prevent JavaScript access for security
                samesite="none"  # Required for cross-site 
            )
            response.headers["Access-Control-Allow-Origin"] = "https://vamory.vadaevri.com"
